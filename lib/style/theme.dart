...
abstract class CustomTheme {
  ...
  static const Color primaryColor =   const Color(0xff6772e5);
  // static const Color primaryColorRed =  const Color(0xFFea202e);
  // static const Color primaryColorRed =  const Color(0xFFea202e);
  static const Color primaryColorRed =  const Color(0xff6772e5);
  ...
  static TextStyle expireDateColoredBodyText = TextStyle(
    fontFamily: 'NunitoSans',
    fontWeight: FontWeight.w700,
    color: colorAccent,
    fontSize: 15,
