...
class HomeScreenLiveTVListHome extends StatelessWidget {
  ...
  HomeScreenLiveTVListHome({required this.tvList, this.title, this.isSearchWidget, this.isDark, this.isFromHomeScreen});
