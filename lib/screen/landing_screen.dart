...
class _LandingScreenState extends State<LandingScreen> with SingleTickerProviderStateMixin {
  ...
  List<String> _widgetTitle = ["Home", "Highlights", "Tv Series", "Favourite"];

  List<Widget> _widgetOptions = <Widget>[HomeScreen(),   MoviesScreen()];
        ...
        itemBuilder: (BuildContext context, int index) {
          if (index == 11)
            return ListTile(
              ...
              title: Container(
                  color: drawerListItem.elementAt(index).isSelected ? Colors.deepPurple : Colors.transparent,
          ...
          return InkWell(
            child: ListTile(
              ...
              title: Text(
                ...
                style: TextStyle(color: drawerListItem.elementAt(index).isSelected ? Colors.deepPurple : CustomTheme.grey_60),
              ),
            ),
            onTap: () {
          ...
          if (index ==3)
            return ListTile(
              ...
              title: Container(
                  ...
                  child: Text(drawerListItem.elementAt(3).navItemName, style: TextStyle(color: CustomTheme.grey_60))),
              trailing: Switch(
                value: isDark,
                activeColor: CustomTheme.primaryColor,
                onChanged: (bool value) {
