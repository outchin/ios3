...
import 'package:oxoo/widgets/home_screen/live_tv_item_home.dart';
  ...
  Widget buildUI({BuildContext? context, PaymentConfig? paymentConfig, AuthUser? authUser, AppConfig? appConfig, required HomeContent homeContent}) {
    return CustomScrollView(
      slivers: <Widget>[
        ...
        // SliverToBoxAdapter( //BANNER AD REMOVED BY ZG
        //   child: BannerAds(
        //     isDark: isDark,
        //   ),
        // ),
        ...
        SliverToBoxAdapter(
          child: Container(
            margin: EdgeInsets.only(top: 5, bottom: 5),
            child: HomeScreenLiveTVListHome(
