...
class HomeContent extends Equatable {
  ...
  @override
  List<Object?> get props => [slider, allCountry, allGenre, featuredTvChannel, latestMovies, latestTvseries, featuresGenreAndMovie];

  @override
  String toString() {
    return 'HomeContent{slider: $slider,  allCountry: $allCountry, allGenre: $allGenre, featuredTvChannel: $featuredTvChannel, latestMovies: $latestMovies, latestTvseries: $latestTvseries, featuresGenreAndMovie: $featuresGenreAndMovie}';
  }
}
